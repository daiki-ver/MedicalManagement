	...
	<body style="background-color: #fafbfe;height: 100%;">
		...
		<c:if test="${sessionScope.userbean==null}">
 		...
 		<script type="text/javascript">
			function tijiao(){
			    document.getElementById("bingli").submit();//js原生方式表单提交
			...
			document.getElementById("hid16").style.display="none";
			document.getElementById("hid17").style.display="none";
