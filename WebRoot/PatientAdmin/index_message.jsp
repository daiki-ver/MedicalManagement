...
<html>
  <head>
	...
	<body style="background-color: #fafbfe;height: 100%;">
		...
		function tijiao(){
			    document.getElementById("huanzhe").submit();//js原生方式表单提交
			}
			function divShow(){
			...
			document.getElementById("hid15").style.display="none";
				...
				<div class="" style=" width: 16%;height: 100%; margin-right: 0px;background-color: #e3f2fd; position: fixed; box-shadow:0px 0px 5px -1px #888888;">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<div class="aside">
							...
							<a class="nav-link active" href="TabChangeServlet?show=patientManager&currentPage=1">患者管理</a>
