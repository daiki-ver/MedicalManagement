...
<html>
  <head>
	...
	<link rel="stylesheet" href="css/zpp.css" type="text/css" />
	...
	<body style="background-color: #fafbfe;height: 100%;">
		...
		document.getElementById("show").style.paddingTop="13px";
		document.getElementById("show1").style.paddingTop="13px";
		document.getElementById("show2").style.paddingTop="13px";
		document.getElementById("show3").style.paddingTop="13px";
		document.getElementById("show4").style.paddingTop="13px";
		document.getElementById("show5").style.paddingTop="13px";
		document.getElementById("show6").style.paddingTop="13px";
		document.getElementById("show7").style.paddingTop="13px";
		
		document.getElementById("hid").style.paddingTop="13px";
		document.getElementById("hid1").style.paddingTop="13px";
		document.getElementById("hid2").style.paddingTop="13px";
		document.getElementById("hid3").style.paddingTop="13px";
		document.getElementById("hid4").style.paddingTop="13px";
		document.getElementById("hid5").style.paddingTop="13px";
		document.getElementById("hid6").style.paddingTop="13px";
		document.getElementById("hid7").style.paddingTop="13px";
		...
		document.getElementById("hid4").style.display="block";
		document.getElementById("hid5").style.display="block";
				...
				<div class="" style=" width: 16%;height: 100%; margin-right: 0px;background-color: #e3f2fd; position: fixed; box-shadow:0px 0px 5px -1px #888888;">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<div class="aside">
							...
							<a class="nav-link" href="TabChangeServlet?show=medicalManager&currentPage=1">病历管理</a>
							<a class="nav-link active" href="TabChangeServlet?show=doctorManager&currentPage=1">医护管理</a>
						</div>
					</div>
				</div>
				<!-- 头部导航 -->
				...
				<div class="" style="width: 68%;height: 100%; position: absolute;margin-top: 80px; margin-left: 15%;">
					...
					<!-- 用户户管理 -->
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							<jsp:include page="Message.jsp" flush="true"></jsp:include>
